var e,t,r,n,i,o,a,s,c,u,l,d,p,h,f,g,v,m,y,b=globalThis;function _(e){return e&&e.__esModule?e.default:e}var w={},k={},E=function(e){return e&&e.Math===Math&&e};// https://github.com/zloirock/core-js/issues/86#issuecomment-115759028
...
return"function"!=typeof e||e.hasOwnProperty("prototype")});var O=Function.prototype.call;$=j?O.bind(O):function(){return O.apply(O,arguments)};var L={}.propertyIsEnumerable,M=Object.getOwnPropertyDescriptor;o=M&&!L.call({1:2},1)?function(e){var t=M(this,e);return!!t&&t.enumerable}:L;var P={};P=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var x={},T={},A={},H=Function.prototype,I=H.call,q=j&&H.bind.bind(I,I),N={},C=(A=j?q:function(e){return function(){return I.apply(e,arguments)}})({}.toString),D=A("".slice);N=function(e){return D(C(e),8,-1)};var R=Object,W=A("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
...
!Symbol.sham&&eo&&eo<41}))&&!Symbol.sham&&"symbol"==typeof Symbol.iterator;var ep=Object;ee=en?function(e){return"symbol"==typeof e}:function(e){var t=et("Symbol");return Y(t)&&er(t.prototype,ep(e))};var eh={},ef={},eg={},ev=String;eg=function(e){try{return ev(e)}catch(e){return"Object"}};var em=TypeError;// `Assert: IsCallable(argument) is true`
ef=function(e){if(Y(e))return e;throw new em(eg(e)+" is not a function")},// `GetMethod` abstract operation
// https://tc39.es/ecma262/#sec-getmethod
eh=function(e,t){var r=e[t];return G(r)?void 0:ef(r)};var ey={},eb=TypeError;// `OrdinaryToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-ordinarytoprimitive
ey=function(e,t){var r,n;if("string"===t&&Y(r=e.toString)&&!V(n=$(r,e))||Y(r=e.valueOf)&&!V(n=$(r,e))||"string"!==t&&Y(r=e.toString)&&!V(n=$(r,e)))return n;throw new eb("Can't convert object to primitive value")};var e_={},ew={};ew=!1;var ek={},eE={},eS=Object.defineProperty;eE=function(e,t){try{eS(k,e,{value:t,configurable:!0,writable:!0})}catch(r){k[e]=t}return t};var eF="__core-js_shared__";ek=k[eF]||eE(eF,{}),(e_=function(e,t){return ek[e]||(ek[e]=void 0!==t?t:{})})("versions",[]).push({version:"3.33.2",mode:ew?"pure":"global",copyright:"\xa9 2014-2023 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.33.2/LICENSE",source:"https://github.com/zloirock/core-js"});var e$={},ej={},eO=Object;// `ToObject` abstract operation
// https://tc39.es/ecma262/#sec-toobject
ej=function(e){return eO(z(e))};var eL=A({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
// eslint-disable-next-line es/no-object-hasown -- safe
e$=Object.hasOwn||function(e,t){return eL(ej(e),t)};var eM={},eP=0,ex=Math.random(),eT=A(1..toString);eM=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eT(++eP+ex,36)};var eA=k.Symbol,eH=e_("wks"),eI=en?eA.for||eA:eA&&eA.withoutSetter||eM,eq=TypeError,eN=(e$(eH,e="toPrimitive")||(eH[e]=ei&&e$(eA,e)?eA[e]:eI("Symbol."+e)),eH[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
J=function(e,t){if(!V(e)||ee(e))return e;var r,n=eh(e,eN);if(n){if(void 0===t&&(t="default"),r=$(n,e,t),!V(r)||ee(r))return r;throw new eq("Can't convert object to primitive value")}return void 0===t&&(t="number"),ey(e,t)},// `ToPropertyKey` abstract operation
// https://tc39.es/ecma262/#sec-topropertykey
B=function(e){var t=J(e,"string");return ee(t)?t:t+""};var eC={},eD={},eR=k.document,eW=V(eR)&&V(eR.createElement);eD=function(e){return eW?eR.createElement(e):{}},// Thanks to IE8 for its funny defineProperty
...
var ez=Object.getOwnPropertyDescriptor;i=S?ez:function(e,t){if(e=x(e),t=B(t),eC)try{return ez(e,t)}catch(e){}if(e$(e,t))return P(!$(o,e,t),e[t])};var eG={},eU={};// V8 ~ Chrome 36-
...
eB=function(e){if(V(e))return e;throw new eV(eJ(e)+" is not an object")};var eY=TypeError,eQ=Object.defineProperty,eK=Object.getOwnPropertyDescriptor,eX="enumerable",eZ="configurable",e0="writable";c=S?eU?function(e,t,r){if(eB(e),t=B(t),eB(r),"function"==typeof e&&"prototype"===t&&"value"in r&&e0 in r&&!r[e0]){var n=eK(e,t);n&&n[e0]&&(e[t]=r.value,r={configurable:eZ in r?r[eZ]:n[eZ],enumerable:eX in r?r[eX]:n[eX],writable:!1})}return eQ(e,t,r)}:eQ:function(e,t,r){if(eB(e),t=B(t),eB(r),eC)try{return eQ(e,t,r)}catch(e){}if("get"in r||"set"in r)throw new eY("Accessors not supported");return"value"in r&&(e[t]=r.value),e},eG=S?function(e,t,r){return c(e,t,P(1,r))}:function(e,t,r){return e[t]=r,e};var e1={},e2={},e3=Function.prototype,e4=S&&Object.getOwnPropertyDescriptor,e7=e$(e3,"name")&&(!S||S&&e4(e3,"name").configurable),e9={},e5=A(Function.toString);Y(ek.inspectSource)||(ek.inspectSource=function(e){return e5(e)}),e9=ek.inspectSource;var e8={},e6={},te=k.WeakMap;e6=Y(te)&&/native code/.test(String(te));var tt={},tr=e_("keys");tt=function(e){return tr[e]||(tr[e]=eM(e))};var tn={};tn={};var ti="Object already initialized",to=k.TypeError,ta=k.WeakMap;if(e6||ek.state){var ts=ek.state||(ek.state=new ta);/* eslint-disable no-self-assign -- prototype methods protection */ts.get=ts.get,ts.has=ts.has,ts.set=ts.set,/* eslint-enable no-self-assign -- prototype methods protection */u=function(e,t){if(ts.has(e))throw new to(ti);return t.facade=e,ts.set(e,t),t},l=function(e){return ts.get(e)||{}},d=function(e){return ts.has(e)}}else{var tc=tt("state");tn[tc]=!0,u=function(e,t){if(e$(e,tc))throw new to(ti);return t.facade=e,eG(e,tc,t),t},l=function(e){return e$(e,tc)?e[tc]:{}},d=function(e){return e$(e,tc)}}var tu=(e8={set:u,get:l,has:d,enforce:function(e){return d(e)?l(e):u(e,{})},getterFor:function(e){return function(t){var r;if(!V(t)||(r=l(t)).type!==e)throw new to("Incompatible receiver, "+e+" required");return r}}}).enforce,tl=e8.get,tp=String,th=Object.defineProperty,tf=A("".slice),tg=A("".replace),tv=A([].join),tm=S&&!F(function(){return 8!==th(function(){},"length",{value:8}).length}),ty=String(String).split("String"),tb=e2=function(e,t,r){"Symbol("===tf(tp(t),0,7)&&(t="["+tg(tp(t),/^Symbol\(([^)]*)\)/,"$1")+"]"),r&&r.getter&&(t="get "+t),r&&r.setter&&(t="set "+t),(!e$(e,"name")||e7&&e.name!==t)&&(S?th(e,"name",{value:t,configurable:!0}):e.name=t),tm&&r&&e$(r,"arity")&&e.length!==r.arity&&th(e,"length",{value:r.arity});try{r&&e$(r,"constructor")&&r.constructor?S&&th(e,"prototype",{writable:!1}):e.prototype&&(e.prototype=void 0)}catch(e){}var n=tu(e);return e$(n,"source")||(n.source=tv(ty,"string"==typeof t?t:"")),e};// add fake Function#toString for correct work wrapped methods / constructors with methods like LoDash isNative
// eslint-disable-next-line no-extend-native -- required
Function.prototype.toString=tb(function(){return Y(this)&&tl(this).source||e9(this)},"toString"),e1=function(e,t,r,n){n||(n={});var i=n.enumerable,o=void 0!==n.name?n.name:t;if(Y(r)&&e2(r,o,n),n.global)i?e[t]=r:eE(t,r);else{try{n.unsafe?e[t]&&(i=!0):delete e[t]}catch(e){}i?e[t]=r:c(e,t,{value:r,enumerable:!1,configurable:!n.nonConfigurable,writable:!n.nonWritable})}return e};var t_={},tw={},tk={},tE={},tS={},tF={},t$=Math.ceil,tj=Math.floor;// `Math.trunc` method
...
indexOf:tT(!1)}.indexOf,tH=A([].push);tk=function(e,t){var r,n=x(e),i=0,o=[];for(r in n)!e$(tn,r)&&e$(n,r)&&tH(o,r);// Don't enum bug & hidden keys
for(;t.length>i;)e$(n,r=t[i++])&&(~tA(o,r)||tH(o,r));return o};var tI=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"].concat("length","prototype");p=Object.getOwnPropertyNames||function(e){return tk(e,tI)},h=Object.getOwnPropertySymbols;var tq=A([].concat);// all object keys, includes non-enumerable and symbols
tw=et("Reflect","ownKeys")||function(e){var t=p(eB(e));return h?tq(t,h(e)):t},t_=function(e,t,r){for(var n=tw(t),o=0;o<n.length;o++){var a=n[o];e$(e,a)||r&&e$(r,a)||c(e,a,i(t,a))}};var tN={},tC=/#|\.prototype\./,tD=function(e,t){var r=tW[tR(e)];return r===tG||r!==tz&&(Y(t)?F(t):!!t)},tR=tD.normalize=function(e){return String(e).replace(tC,".").toLowerCase()},tW=tD.data={},tz=tD.NATIVE="N",tG=tD.POLYFILL="P";tN=tD,/*
...
if(a=t[n],o=e.dontCallGetSet?(s=i(r,n))&&s.value:r[n],!tN(u?n:c+(l?".":"#")+n,e.forced)&&void 0!==o){if(typeof a==typeof o)continue;t_(a,o)}(e.sham||o&&o.sham)&&eG(a,"sham",!0),e1(r,n,a,e)}};var tU={},tB={},tJ=Function.prototype,tV=tJ.apply,tY=tJ.call;// eslint-disable-next-line es/no-reflect -- safe
tB="object"==typeof Reflect&&Reflect.apply||(j?tY.bind(tV):function(){return tY.apply(tV,arguments)});var tQ={},tK={},tX=(tK=function(e){// Nashorn bug:
//   https://github.com/zloirock/core-js/issues/1128
//   https://github.com/zloirock/core-js/issues/1130
if("Function"===N(e))return A(e)})(tK.bind);// optional / simple context binding
tQ=function(e,t){return ef(e),void 0===t?e:j?tX(e,t):function(){return e.apply(t,arguments)}};var tZ={};tZ=et("document","documentElement");var t0={};t0=A([].slice);var t1={},t2=TypeError;t1=function(e,t){if(e<t)throw new t2("Not enough arguments");return e};var t3={};// eslint-disable-next-line redos/no-vulnerable -- safe
t3=/(?:ipad|iphone|ipod).*applewebkit/i.test(ea);var t4={};t4="process"===N(k.process);var t7=k.setImmediate,t9=k.clearImmediate,t5=k.process,t8=k.Dispatch,t6=k.Function,re=k.MessageChannel,rt=k.String,rr=0,rn={},ri="onreadystatechange";F(function(){// Deno throws a ReferenceError on `location` access without `--location` flag
f=k.location});var ro=function(e){if(e$(rn,e)){var t=rn[e];delete rn[e],t()}},ra=function(e){return function(){ro(e)}},rs=function(e){ro(e.data)},rc=function(e){// old engines have not location.origin
k.postMessage(rt(e),f.protocol+"//"+f.host)};t7&&t9||(t7=function(e){t1(arguments.length,1);var t=Y(e)?e:t6(e),r=t0(arguments,1);return rn[++rr]=function(){tB(t,void 0,r)},g(rr),rr},t9=function(e){delete rn[e]},t4?g=function(e){t5.nextTick(ra(e))}:t8&&t8.now?g=function(e){t8.now(ra(e))}:re&&!t3?(m=(v=new re).port2,v.port1.onmessage=rs,g=tQ(m.postMessage,m)):k.addEventListener&&Y(k.postMessage)&&!k.importScripts&&f&&"file:"!==f.protocol&&!F(rc)?(g=rc,k.addEventListener("message",rs,!1)):g=ri in eD("script")?function(e){tZ.appendChild(eD("script"))[ri]=function(){tZ.removeChild(this),ro(e)}}:function(e){setTimeout(ra(e),0)});var ru=(tU={set:t7,clear:t9}).clear;// `clearImmediate` method
// http://w3c.github.io/setImmediate/#si-clearImmediate
w({global:!0,bind:!0,enumerable:!0,forced:k.clearImmediate!==ru},{clearImmediate:ru});var rl=tU.set,rd={},rp={};/* global Bun -- Deno case */rp="function"==typeof Bun&&Bun&&"string"==typeof Bun.version;var rh=k.Function,rf=/MSIE .\./.test(ea)||rp&&((t=k.Bun.version.split(".")).length<3||"0"===t[0]&&(t[1]<3||"3"===t[1]&&"0"===t[2]));// IE9- / Bun 0.3.0- setTimeout / setInterval / setImmediate additional parameters fix
// https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#timers
// https://github.com/oven-sh/bun/issues/1633
rd=function(e,t){var r=t?2:1;return rf?function(n,i/* , ...arguments */){var o=t1(arguments.length,1)>r,a=Y(n)?n:rh(n),s=o?t0(arguments,r):[],c=o?function(){tB(a,this,s)}:a;return t?e(c,i):e(c)}:e};// https://github.com/oven-sh/bun/issues/1633
var rg=k.setImmediate?rd(rl,!1):rl;// `setImmediate` method
// http://w3c.github.io/setImmediate/#si-setImmediate
w({global:!0,bind:!0,enumerable:!0,forced:k.setImmediate!==rg},{setImmediate:rg});const rv="https://forkify-api.herokuapp.com/api/v2/recipes/",rm="9e2d287a-7bb9-4caf-908a-bf5afe057e25",ry=e=>new Promise((t,r)=>{setTimeout(()=>{r(Error(`Request took too long! Timeout after ${e} second`))},1e3*e)}),rb=async(e,t)=>{try{let r=t?fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):fetch(e),n=await Promise.race([r,ry(10)]),i=await n.json();if(!n.ok)throw Error(`${i.message} (${n.status})`);return i}catch(e){throw e}},r_={recipe:{},search:{query:"",results:[],page:1,resultsPerPage:10},bookmarks:[]},rw=e=>{let{recipe:t}=e.data;return{id:t.id,title:t.title,publisher:t.publisher,sourceUrl:t.source_url,image:t.image_url,servings:t.servings,cookingTime:t.cooking_time,ingredients:t.ingredients,//key property assigned only if the key exist
...t.key&&{key:t.key}}},rk=async e=>{try{let t=await rb(`${rv}${e}?key=${rm}`);r_.recipe=rw(t),r_.bookmarks.some(t=>t.id===e)?r_.recipe.bookmarked=!0:r_.recipe.bookmarked=!1}catch(e){throw console.error(`${e}\u{1F4A3}\u{1F4A3}\u{1F4A3}`),e}},rE=async e=>{try{r_.search.query=e;let t=await rb(`${rv}?search=${e}&key=${rm}`);console.log(t),r_.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}})),r_.search.page=1}catch(e){throw console.error(`${e}\u{1F4A3}\u{1F4A3}\u{1F4A3}`),e}},rS=(e=r_.search.page)=>{r_.search.page=e;let t=(e-1)*r_.search.resultsPerPage,r=e*r_.search.resultsPerPage;//0
return r_.search.results.slice(t,r)},rF=e=>{console.log("ing",r_.recipe.ingredients),r_.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/r_.recipe.servings}),r_.recipe.servings=e},r$=()=>{localStorage.setItem("bookmarks",JSON.stringify(r_.bookmarks))},rj=e=>{//Add bookmark
r_.bookmarks.push(e),e.id===r_.recipe.id&&(r_.recipe.bookmarked=!0),r$()},rO=e=>{//Delete bookmark
let t=r_.bookmarks.findIndex(t=>t.id===e);r_.bookmarks.splice(t,1),e===r_.recipe.id&&(r_.recipe.bookmarked=!1),r$()};(()=>{let e=localStorage.getItem("bookmarks");e&&(r_.bookmarks=JSON.parse(e))})(),console.log(r_.bookmarks);const rL=async e=>{try{let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{// const ingArr = ing[1].replaceAll(" ", "").split(",");
let t=e[1].split(",").map(e=>e.trim());if(3!==t.length)throw Error("Wrong ingredient format! Please use the correct format :)");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,source_url:e.sourceUrl,image_url:e.image,publisher:e.publisher,cooking_time:+e.cookingTime,servings:+e.servings,ingredients:t},n=await rb(`${rv}?key=${rm}`,r);r_.recipe=rw(n),rj(r_.recipe)}catch(e){throw e}};var rM={};rM=new URL("icons.c14567a0.svg",import.meta.url).toString();class rP{_data;/**
   * Render the received object to the DOM
   * @param {Object | Object[]} data The data to be rendered(e.g. receipe)
   * @param {boolean} [render=true] If false, create markup string instead of rendering to the DOM
   * @returns {undefined | string} A markup string is returned if render = false
   * @this {Object} View object
   * @author Punith Raj Kumar
...
`}_generateMarkupIngredient(e){return`
    ...
    `}}var rT=new rx;class rA extends rP{_parentElement=document.querySelector(".search");getQuery(){let e=this._parentElement.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentElement.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentElement.addEventListener("submit",t=>{t.preventDefault(),e()})}}var rH=new rA,rI=new class extends rP{_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`
    <li class="preview">
    ...
    `}};class rq extends rP{_parentElement=document.querySelector(".results");_errorMessage="No recipes found for your query! Please try again :)";_message="";_generateMarkup(){return this._data.map(e=>rI.render(e,!1)).join("")}}var rN=new rq;class rC extends rP{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it :)";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>rI.render(e,!1)).join("")}}var rD=new rC;class rR extends rP{_parentElement=document.querySelector(".pagination");addHandlerClick(e){this._parentElement.addEventListener("click",t=>{let r=t.target.closest(".btn--inline");if(console.log(r),!r)return;let n=+r.dataset.goto;console.log("goto",n),e(n)})}_generateMarkup(){let e=this._data.page,t=Math.ceil(this._data.results.length/this._data.resultsPerPage);return(//Page 1
1===e&&t>1?`
...
i(c,"_invoke",{value:(a=new j(o||[]),s=p,function(r,i){if(s===h)throw Error("Generator is already running");if(s===f){if("throw"===r)throw i;// Be forgiving, per 25.3.3.3.3 of the spec:
...
(this.arg=t),g}},e}({});try{regeneratorRuntime=rU}catch(e){// This module should not be running in strict mode, so the above
...
"object"==typeof globalThis?globalThis.regeneratorRuntime=rU:Function("r","regeneratorRuntime = r")(rU)}const rB=async()=>{try{let e=window.location.hash.slice(1);if(!e)return;rT.renderSpinner(),rN.update(rS()),rD.update(r_.bookmarks),//2 Loading recipe
await rk(e),rT.render(r_.recipe)}catch(e){rT.renderError(`${e}\u{1F4A3}\u{1F4A3}\u{1F4A3}`)}},rJ=async()=>{try{rN.renderSpinner(),console.log("resultsView:",rN);//1 Get search query
let e=rH.getQuery();if(!e)return;//2 Load search results
await rE(e),rN.render(rS()),rW.render(r_.search)}catch(e){console.error(e)}},rV=async e=>{try{rG.renderSpinner(),//Upload new recipe data
await rL(e),console.log(r_.recipe),rT.render(r_.recipe),rG.renderMessage(),rD.render(r_.bookmarks),//Change ID in URL
window.history.pushState(null,"",`#${r_.recipe.id}`),//Close form window
setTimeout(()=>{rG.toggleWindow()},1e3)}catch(e){rG.renderError(e.message)}};rD.addHandlerRender(()=>{rD.render(r_.bookmarks)}),rT.addHandlerRender(rB),rT.addHandlerUpdateServings(e=>{//Update the receipe servings (in state)
rF(e),rT.update(r_.recipe)}),rT.addHandlerAddBookmark(()=>{r_.recipe.bookmarked?rO(r_.recipe.id):rj(r_.recipe),rT.update(r_.recipe),rD.render(r_.bookmarks)}),rH.addHandlerSearch(rJ),rW.addHandlerClick(e=>{rN.render(rS(e)),rW.render(r_.search),console.log(e)}),rG.addHandlerUpload(rV);//# sourceMappingURL=index.692d7207.js.map

//# sourceMappingURL=index.692d7207.js.map
